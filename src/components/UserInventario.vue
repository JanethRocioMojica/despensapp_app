  ...
  import axios from 'axios';
    export default {
      ...
      actualizarprecio: function(){
        ...
        axios.put("https://despensapp-b.herokuapp.com/inventario/actualizar_precio", update,{headers: {"Access-Control-Allow-Origin": "https://despensapp-b.herokuapp.com/inventario/actualizar_precio"}})
        .then((result) => {
